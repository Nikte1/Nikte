...
<head>
    ...
    <style>
        ...
        nav {
            text-align: center;
            background: #fff5e1; /* Fondo suave para el menú de navegación */
            padding: 20px;
        ...
        nav ul li a {
            ...
            font-size: 1.2em;
            padding: 10px 20px;
            border: 2px solid #d89e6e; /* Borde dorado */
            border-radius: 5px;
            transition: background 0.3s, color 0.3s;
        }
        nav ul li a:hover {
            background: #d89e6e; /* Color de fondo dorado cuando se pasa el mouse */
            color: white; /* Cambia el color del texto */
            border-color: #d89e6e; /* Resalta el borde */
        }
        nav ul li a:active {
            background: #b47c52; /* Tono más oscuro cuando se hace clic */
            border-color: #b47c52;
        }
    </style>
</head>
